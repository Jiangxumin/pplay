    ...
    <View style={styles.container}>
      <TouchableWithoutFeedback onPress={showControls}>
        <View style={styles.wrapper}>
          {/* textureView avoids the "Cannot use shared object that was already released" crash
              that SurfaceVideoView hits when this component unmounts/remounts (rotation, episode
              change, Fast Refresh). See expo-video docs on surfaceType. */}
          <VideoView ref={videoRef} player={player} style={styles.video} contentFit="contain" nativeControls={false} surfaceType="textureView" />

          {/* Back — always visible above controls; safe-area offset is owned by PlayerScreen */}
